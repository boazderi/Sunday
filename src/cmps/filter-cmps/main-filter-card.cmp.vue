  ...
  <section class="">
    <article v-if="filterOptions" class="main-filter-card flex flex-col">
      ...
      <div
        ...
        v-if="title === 'priority' || title === 'status'"
      >
        <div
          class="main-filter-card-item outboard-hover"
          v-for="(label, idx) in filterOptions[title].labels"
          :class="{
            'active-card-filter-item': acitvesLabels.some((currLabel) => currLabel === label),
          }"
        ...
        >
          <div
            ...
            :style="{
              backgroundColor: filterOptions[title].backgroundColor[idx],
            }"
          ></div>
          <div>{{ label }}</div>
        </div>
      ...
      <div class="card-items-container" v-else>
        ...
        >
          <img
            class="card-member-pic"
            :src="filterOptions[title].imgUrls[idx]"
          />
